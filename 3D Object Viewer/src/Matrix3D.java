...
by Ken Perlin (http://mrl.nyu.edu/perlin) @ NYU, 1998.

You have my permission to use freely, as long
as you keep the attribution. - Ken Perlin

Note: this Matrix3D.html file also
works as a legal Matrix3D.java file.
...
The classes Vector3D and Matrix3D
are extended from respective generic classes
VectorN and MatrixN,
which do most of the bookkeeping for
arithmetic vectors of length N and
square matrices of size N x N, respectively.
*/
